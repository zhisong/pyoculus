########################################
# continued_fraction.py: contain functions related to the continued fraction expansion
...
def expandcf(irrational, n, thres_ai=1000):
    ...
    Returns:
        ai -- an integer sequence contains the continued fraction expansion of irrational up to the nth term
    '''
...
def fromcf(ai):
    ...
    parameters:
        ai -- an integer array contains ai for the continued fraction expansion
