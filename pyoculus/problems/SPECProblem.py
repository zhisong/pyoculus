...
class SPECProblem(BaseProblem):
    ...
    def __init__(self, spec_data, lvol):
        ...
        fortran_module.specvariables.notstellsym = (spec_data.input.physics.Istellsym == 0)
        ...
        if (lvol > 0 and lvol <= spec_data.output.Mvol):
            ...
            fortran_module.specvariables.ate = spec_data.vector_potential.Ate[lvol-1].T
            fortran_module.specvariables.ato = spec_data.vector_potential.Ato[lvol-1].T
            fortran_module.specvariables.aze = spec_data.vector_potential.Aze[lvol-1].T
            fortran_module.specvariables.azo = spec_data.vector_potential.Azo[lvol-1].T
            fortran_module.specvariables.lcoordinatesingularity = (spec_data.input.physics.Igeometry>=2 and lvol==1)
