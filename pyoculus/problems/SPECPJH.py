...
class SPECPJH(SPECProblem):
    ...
    def __init__(self, spec_data, lvol, dp=0.0, innout=0, plusminus=+1):
        ...
        parameters:
            ...
            dp -- the delta p for PJH
            innout -- 0 for inner surface, 1 for outer surface
            plusminus -- the sign for computing p_zeta, +1 or -1
        '''
        super().__init__(spec_data, lvol)

        self.fortran_module.pjh.init_pjh(dp, innout, plusminus)
        self.dp = dp
        self.innout = innout
    ...
    def f(self, zeta, st, arg1=None):
        ...
        '''
        return self.fortran_module.pjh.get_pjhfield(zeta, st)
    ...
    def f_tangent(self, zeta, st, arg1=None):
        ...
        '''
        return self.fortran_module.pjh.get_pjhfield_tangent(zeta, st)
